...
Adapted from Michelle Athay's new_athena_read.py (originally Athena++ /vis/python/athena_read.py)
"""
...
def read_athdf(filename, raw=False, data=None, quantities=None, dtype=None, level=None,
    ...
    xi_min/max are the coordinate values (not the array indices)
    """
